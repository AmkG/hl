...
DECLARE_BYTECODES
	...
	A_BYTECODE(enclose)
	A_BYTECODE(err_handler)
	A_BYTECODE(err_handler_set)
  ...
  //A_BYTECODE(if_local)
	...
	A_BYTECODE(proc_local)
	A_BYTECODE(proc_local_set)
        A_BYTECODE(recv)
	A_BYTECODE(reducto)
	...
	A_BYTECODE(sp_ref)
        A_BYTECODE(spawn)
	A_BYTECODE(string_builder)
	A_BYTECODE(string_create)
	A_BYTECODE(string_length)
	A_BYTECODE(string_pointer)
